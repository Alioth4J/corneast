...
public class NettyTwoHandler extends SimpleChannelInboundHandler<RequestProto.RequestDTO> implements NettyCustomHandler {

    private static final Logger log = LoggerFactory.getLogger(NettyTwoHandler.class);

    public NettyTwoHandler() {
    }
